...
module internal JsonCodeEmitterImpl =
    ...
    let emittedFqn (info: SerdeTypeInfo) : string =
        ...
        | Some ctx ->
            ...
            let argNames = ctx.GenericArguments |> List.map Types.typeInfoToFqFSharpType
    ...
    let emitRecord (info: SerdeTypeInfo) : string =
        ...
        appendf "module rec Serde.Generated.%s" name
        append ""
        append "open System"
        ...
        append ""
        appendf "[<AutoOpen>]"
        appendf "module internal %sSerdeTypeInfo =" name
        append ""
    ...
    let emitUnion (info: SerdeTypeInfo) : string =
        ...
        for i, case in activeCases |> List.mapi (fun i x -> i, x) do
            ...
            | TupleFields ->
                ...
                appendf "                %s.%s(%s)" caseFqn case.RawCaseName args
            | RecordFields ->
                appendf "                if reader.TokenType <> JsonTokenType.StartObject then"
